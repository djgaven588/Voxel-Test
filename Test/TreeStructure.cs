    ...
    public TreeStructure(BlockManager blocks, BiomeManager biomes)
    {
        ...
        Varients = new Varient[]
        {
            new Varient() {
                ...
                .Add(new StructureBuilder.Box(new Vector3Int(0,0,0), Vector3Int.Up * 6), wood, true)
            ...
            new Varient() {
                Entries = StructureBuilder.Start()
                .Add(new StructureBuilder.Box(new Vector3Int(0,0,0), Vector3Int.Up * 3), wood, true)
